...
{
    public class ProduceUnitThrowerCommandExecutor : CommandExecutorBase<IProduceUnitThrowerCommand>, IUnitProducer
    {
        ...
        public override async Task ExecuteSpecificCommand(IProduceUnitThrowerCommand command)
        {
